  ...
  return (
    <div id="About" className="About">
      <div className="container">
        <p>¿Quiénes Somos?</p>
        <span>
          Somos una empresa de administración de Condominios, ubicada en la
          Uruca, realizando servicios de alta calidad. Actualmente con presencia
          en el GAM, expresamente en la Uruca, Desamparados (San José), Heredia
          y en San Carlos. Utilizamos la tecnología como parte esencial de
          nuestro servicio y contamos con un equipo altamente calificado para
          solventar las necesidades de nuestros clientes. Con más de 15 años de
